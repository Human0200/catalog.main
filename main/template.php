	...
	<div class="catalog-detail__main">
		...
		<div class="catalog-detail__main-parts line-block line-block--32">
			<div class="catalog-detail__main-part catalog-detail__main-part--left flex-1 line-block__item grid-list grid-list--gap-30">								
				...
				<?if($arResult['CHARACTERISTICS'] && $cntVisibleChars != 0):?>
			...
			<div class="catalog-detail__main-part catalog-detail__main-part--right sticky-block flex-1 line-block__item grid-list grid-list--items-1 grid-list--gap-8 grid-list--fill-bg">
				...
				<? else: ?>
					...
					?>
                <?
                if ($arResult["PROPERTIES"]["AVAILABILITY"]["VALUE_XML_ID"] == "in_stock") { ?>
					<?=$arBasketConfig['HTML']?>
                <?}
                else{?>
                    <a href="/request_price/?name=<?=$elementName;?>" class="btn btn-light btn-wide
                                                     has-ripple">
                        <!--                                                        --><?php //=$arBasketConfig['HTML']?>Узнать цену
                    </a>
               <? }?>
				<? endif; ?>
				<?
					...
					<div class="catalog-detail__buy-block catalog-detail__cell-block outer-rounded-x shadow" itemprop="offers" itemscope itemtype="http://schema.org/Offer" data-id="<?=$arResult['ID']?>" data-item="<?=$dataItem;?>">
                        ...
                        <div class="line-block line-block--20 line-block--16-vertical line-block--align-normal flexbox--wrap flexbox--justify-beetwen<?= ($priceHtml ? '' : ' hidden') ?>">
                            <div class="line-block__item catalog-detail__price catalog-detail__info--margined js-popup-price"
                                 data-price-config='<?= str_replace(
                                     '\'',
                                     '"',
                                     CUtil::PhpToJSObject($arPriceConfig, false, true)
                                 ) ?>'>
                                <? if ($arResult["PROPERTIES"]["AVAILABILITY"]["VALUE_XML_ID"] == "in_stock") {?>
                                <?= $priceHtml ?>
                                <? }?>
                                <div style="display: flex;">
                                    ...
                                    if ($arResult["PROPERTIES"]["AVAILABILITY"]["VALUE_XML_ID"] == "in_stock") { ?>
                                        ...
                                        ?>
                                        <span class="status-container  not_available" data-state="not_available">
                                <img src="/images/truck.png" style="width:25px">
                                </span>
                                    <?
                                    } ?>

                                    <span
                                            class="status <?= $arResult["PROPERTIES"]["AVAILABILITY"]["VALUE_XML_ID"] ?>"><?
                                        echo
                                        $arResult["PROPERTIES"]["AVAILABILITY"]["VALUE"] ?></span>
                                </div>
                            </div>
                        </div>
